...
const std::vector<std::pair<TickerType, std::string>> TitanTickersNameMap = {
    ...
    {TITAN_NUM_KEYS_WRITTEN, "titandb.num.keys.written"},
    {TITAN_NUM_KEYS_READ, "titandb.num.keys.read"},
    {TITAN_BYTES_WRITTEN, "titandb.bytes.written"},
    {TITAN_BYTES_READ, "titandb.bytes.read"},
