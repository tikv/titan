...
genrule(
    ...
    cmd = "GIT_DIR=external/com_github_pingcap_rocksdb/.git; " +
          "GIT_SHA=$$(cat $$GIT_DIR/HEAD | cut -d \" \" -f 2 | xargs -I {} cat $$GIT_DIR/{} || echo 'v6.4.tikv'); " +
          "sed -e s/@@GIT_SHA@@/$$GIT_SHA/ -e s/@@GIT_DATE_TIME@@/$$(date +%F)/ " +
          "external/com_github_pingcap_rocksdb/util/build_version.cc.in >> $(@)",
)
